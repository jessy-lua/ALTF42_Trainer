...
namespace Offsets
{
	constexpr int32 GObjects          = 0x00;
	constexpr int32 AppendString      = 0x00;
	constexpr int32 GNames            = 0x07371580;
	constexpr int32 GWorld            = 0x07585AC8;
	constexpr int32 ProcessEvent      = 0x00EED2F0;
