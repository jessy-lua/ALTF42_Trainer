...
#include "BP_FrameRate_Setting_classes.hpp"
#include "BP_FrameRate_Setting_parameters.hpp"
...
void UBP_FrameRate_Setting_C::ExecuteUbergraph_BP_FrameRate_Setting(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_FrameRate_Setting_C", "ExecuteUbergraph_BP_FrameRate_Setting");

	Params::BP_FrameRate_Setting_C_ExecuteUbergraph_BP_FrameRate_Setting Parms{};
...
void UBP_FrameRate_Setting_C::OnApply(class UPDA_SettingsData_C* SettingsData, const struct FFValueTypes& Value, class UBP_SettingsManager_C* SettingsManager)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_FrameRate_Setting_C", "OnApply");

	Params::BP_FrameRate_Setting_C_OnApply Parms{};
