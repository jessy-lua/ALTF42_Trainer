...
// BlueprintGeneratedClass AI_MH_Tuto.AI_MH_Tuto_C
// 0x03A0 (0x0EF0 - 0x0B50)
...
public:
	...
	class UStaticMeshComponent*                   SM_Tuto_Goates;                                    // 0x0B60(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UStaticMeshComponent*                   SM_Tuto_EyeBrows;                                  // 0x0B68(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class USkeletalMeshComponent*                 SK_Belt;                                           // 0x0B70(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UStaticMeshComponent*                   SM_Top_Acc;                                        // 0x0B78(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UStaticMeshComponent*                   SM_Bag_01;                                         // 0x0B80(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UStaticMeshComponent*                   SM_Bag_03;                                         // 0x0B88(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UStaticMeshComponent*                   SM_Tuto_Helmet;                                    // 0x0B90(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class USkeletalMeshComponent*                 SK_Feather_02;                                     // 0x0B98(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class USkeletalMeshComponent*                 TutoBody;                                          // 0x0BA0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class ULODSyncComponent*                      LODSync;                                           // 0x0BA8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class FText>                           NPC_TalkText_List;                                 // 0x0E88(0x0010)(Edit, BlueprintVisible)
	...
	bool                                          GoAway_;                                           // 0x0EE0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"AI_MH_Tuto_C">();
	}
	static class AAI_MH_Tuto_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AAI_MH_Tuto_C>();
	}
};
static_assert(alignof(AAI_MH_Tuto_C) == 0x000010, "Wrong alignment on AAI_MH_Tuto_C");
static_assert(sizeof(AAI_MH_Tuto_C) == 0x000EF0, "Wrong size on AAI_MH_Tuto_C");
static_assert(offsetof(AAI_MH_Tuto_C, UberGraphFrame_AI_MH_Tuto_C) == 0x000B48, "Member 'AAI_MH_Tuto_C::UberGraphFrame_AI_MH_Tuto_C' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Groom) == 0x000B50, "Member 'AAI_MH_Tuto_C::Groom' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, SM_Tuto_Mustache) == 0x000B58, "Member 'AAI_MH_Tuto_C::SM_Tuto_Mustache' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, SM_Tuto_Goates) == 0x000B60, "Member 'AAI_MH_Tuto_C::SM_Tuto_Goates' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, SM_Tuto_EyeBrows) == 0x000B68, "Member 'AAI_MH_Tuto_C::SM_Tuto_EyeBrows' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, SK_Belt) == 0x000B70, "Member 'AAI_MH_Tuto_C::SK_Belt' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, SM_Top_Acc) == 0x000B78, "Member 'AAI_MH_Tuto_C::SM_Top_Acc' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, SM_Bag_01) == 0x000B80, "Member 'AAI_MH_Tuto_C::SM_Bag_01' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, SM_Bag_03) == 0x000B88, "Member 'AAI_MH_Tuto_C::SM_Bag_03' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, SM_Tuto_Helmet) == 0x000B90, "Member 'AAI_MH_Tuto_C::SM_Tuto_Helmet' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, SK_Feather_02) == 0x000B98, "Member 'AAI_MH_Tuto_C::SK_Feather_02' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, TutoBody) == 0x000BA0, "Member 'AAI_MH_Tuto_C::TutoBody' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, LODSync) == 0x000BA8, "Member 'AAI_MH_Tuto_C::LODSync' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Hit_Head_Coillsion) == 0x000BB0, "Member 'AAI_MH_Tuto_C::Hit_Head_Coillsion' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Hit_Top_Coillsion) == 0x000BB8, "Member 'AAI_MH_Tuto_C::Hit_Top_Coillsion' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Char_TalkOverlap_Check) == 0x000BC0, "Member 'AAI_MH_Tuto_C::Char_TalkOverlap_Check' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Foot_Block_SM) == 0x000BC8, "Member 'AAI_MH_Tuto_C::Foot_Block_SM' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, HeldObjectRoot) == 0x000BD0, "Member 'AAI_MH_Tuto_C::HeldObjectRoot' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, StaticMesh) == 0x000BD8, "Member 'AAI_MH_Tuto_C::StaticMesh' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, SkeletalMesh) == 0x000BE0, "Member 'AAI_MH_Tuto_C::SkeletalMesh' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Mantle_2m_Default) == 0x000BE8, "Member 'AAI_MH_Tuto_C::Mantle_2m_Default' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Mantle_1m_Default) == 0x000C28, "Member 'AAI_MH_Tuto_C::Mantle_1m_Default' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Mantle_1m_RH) == 0x000C68, "Member 'AAI_MH_Tuto_C::Mantle_1m_RH' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Mantle_1m_LH) == 0x000CA8, "Member 'AAI_MH_Tuto_C::Mantle_1m_LH' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Mantle_1m_2H) == 0x000CE8, "Member 'AAI_MH_Tuto_C::Mantle_1m_2H' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Mantle_1m_Box) == 0x000D28, "Member 'AAI_MH_Tuto_C::Mantle_1m_Box' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, LandRoll_Default) == 0x000D68, "Member 'AAI_MH_Tuto_C::LandRoll_Default' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, GetUpFront_Default) == 0x000D70, "Member 'AAI_MH_Tuto_C::GetUpFront_Default' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, LandRoll_RH) == 0x000D78, "Member 'AAI_MH_Tuto_C::LandRoll_RH' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, LandRoll_LH) == 0x000D80, "Member 'AAI_MH_Tuto_C::LandRoll_LH' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, LandRoll_2H) == 0x000D88, "Member 'AAI_MH_Tuto_C::LandRoll_2H' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, GetUpFront_RH) == 0x000D90, "Member 'AAI_MH_Tuto_C::GetUpFront_RH' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, GetUpFront_LH) == 0x000D98, "Member 'AAI_MH_Tuto_C::GetUpFront_LH' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, GetUpFront_2H) == 0x000DA0, "Member 'AAI_MH_Tuto_C::GetUpFront_2H' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, GetUpBack_Default) == 0x000DA8, "Member 'AAI_MH_Tuto_C::GetUpBack_Default' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, GetUpBack_RH) == 0x000DB0, "Member 'AAI_MH_Tuto_C::GetUpBack_RH' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, GetUpBack_LH) == 0x000DB8, "Member 'AAI_MH_Tuto_C::GetUpBack_LH' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, GetUpBack_2H) == 0x000DC0, "Member 'AAI_MH_Tuto_C::GetUpBack_2H' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, ALTF42_GI) == 0x000DC8, "Member 'AAI_MH_Tuto_C::ALTF42_GI' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, ImPlayer) == 0x000DD0, "Member 'AAI_MH_Tuto_C::ImPlayer' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Who_NPC) == 0x000DD1, "Member 'AAI_MH_Tuto_C::Who_NPC' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, NPC_NAme) == 0x000DD8, "Member 'AAI_MH_Tuto_C::NPC_NAme' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, NPC_Image) == 0x000DF0, "Member 'AAI_MH_Tuto_C::NPC_Image' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Hit_) == 0x000DF8, "Member 'AAI_MH_Tuto_C::Hit_' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Loop_Active) == 0x000DF9, "Member 'AAI_MH_Tuto_C::Loop_Active' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, NPC_StartAction_) == 0x000DFA, "Member 'AAI_MH_Tuto_C::NPC_StartAction_' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, NPC_ActionMode) == 0x000DFB, "Member 'AAI_MH_Tuto_C::NPC_ActionMode' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, NPC_Action_Anim) == 0x000E00, "Member 'AAI_MH_Tuto_C::NPC_Action_Anim' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, NPC_Act) == 0x000E08, "Member 'AAI_MH_Tuto_C::NPC_Act' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Npc_MoveTarget) == 0x000E10, "Member 'AAI_MH_Tuto_C::Npc_MoveTarget' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, NPC_Hit_Anim) == 0x000E18, "Member 'AAI_MH_Tuto_C::NPC_Hit_Anim' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Hit_Talk) == 0x000E20, "Member 'AAI_MH_Tuto_C::Hit_Talk' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Meet_HI_Anim) == 0x000E38, "Member 'AAI_MH_Tuto_C::Meet_HI_Anim' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, MeetHI_PlayRate) == 0x000E40, "Member 'AAI_MH_Tuto_C::MeetHI_PlayRate' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, GiveItem_AnimMontage) == 0x000E48, "Member 'AAI_MH_Tuto_C::GiveItem_AnimMontage' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, GiveItem_Play_Rate) == 0x000E50, "Member 'AAI_MH_Tuto_C::GiveItem_Play_Rate' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, NPC_Act_List) == 0x000E58, "Member 'AAI_MH_Tuto_C::NPC_Act_List' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, NPC_Act_AnimList) == 0x000E68, "Member 'AAI_MH_Tuto_C::NPC_Act_AnimList' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Npc_MoveTarget_List) == 0x000E78, "Member 'AAI_MH_Tuto_C::Npc_MoveTarget_List' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, NPC_TalkText_List) == 0x000E88, "Member 'AAI_MH_Tuto_C::NPC_TalkText_List' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Talk_Text) == 0x000E98, "Member 'AAI_MH_Tuto_C::Talk_Text' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Act_Integer) == 0x000EB0, "Member 'AAI_MH_Tuto_C::Act_Integer' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Random_Roam_) == 0x000EB4, "Member 'AAI_MH_Tuto_C::Random_Roam_' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Act_Random_Caculation) == 0x000EB8, "Member 'AAI_MH_Tuto_C::Act_Random_Caculation' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Item_Plus_Value) == 0x000EBC, "Member 'AAI_MH_Tuto_C::Item_Plus_Value' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, NPC_Give_Item) == 0x000EC0, "Member 'AAI_MH_Tuto_C::NPC_Give_Item' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, NPC_Talking_) == 0x000EC1, "Member 'AAI_MH_Tuto_C::NPC_Talking_' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Action_Start_Time) == 0x000EC8, "Member 'AAI_MH_Tuto_C::Action_Start_Time' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Flag_01) == 0x000ED0, "Member 'AAI_MH_Tuto_C::Flag_01' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, Flag_02) == 0x000ED8, "Member 'AAI_MH_Tuto_C::Flag_02' has a wrong offset!");
static_assert(offsetof(AAI_MH_Tuto_C, GoAway_) == 0x000EE0, "Member 'AAI_MH_Tuto_C::GoAway_' has a wrong offset!");
