...
public:
	...
	uint8                                         Pad_1768[0x4];                                     // 0x02B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1769[0x4];                                     // 0x02EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_176A[0x18];                                    // 0x02F8(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_176C[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_176D[0x68];                                    // 0x01C8(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_176E[0x8];                                     // 0x0570(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_176F[0x1];                                     // 0x058A(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1770[0x44];                                    // 0x058C(0x0044)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1771[0x10];                                    // 0x05E0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
